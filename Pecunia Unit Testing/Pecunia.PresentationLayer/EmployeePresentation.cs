    ...
    public static class EmployeePresentation
    {
        ...
        public static async Task<int> EmployeeMenu()
        {
            ...
            do
            {
                ...
                WriteLine("-----------------------");
                WriteLine("1. Loan Menu");
                WriteLine("2. Account Menu");
                WriteLine("3. Customer Menu");
                WriteLine("4. Transaction Menu");
                ...
                LoanPresentation loan = new LoanPresentation();
                ...
                if (isValidChoice)
                {
                    switch (choice)
                    {
                        ...
                        case 1: await loan.MenuOfLoan(); break;
                        case 2: await AccountPresentation.MenuOfAccount(); break;
                        case 3: await CustomerPresentation.DisplayMenu(); break;
                        case 4: await TransactionPresentation.MenuOfTransaction(); break;
                        case 5: await ChangeEmployeePassword(); break;
                        case 0: break;
                        case -1: break;
