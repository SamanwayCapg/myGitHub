...
namespace Capgemini.Pecunia.Contracts.DALContracts
{
    ...
    {
        public abstract bool StoreTransactionRecord(Guid accountID, double amount, TypeOfTransaction type, ModeOfTransaction mode, string chequeNumber);
        ...
        public abstract DataSet GetAllTransactionsDAL();
