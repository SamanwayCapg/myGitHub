...
export class LoanDataService implements InMemoryDbService {
  ...
  createDb() {
    ...
    let carloans = [
        ...
        new CarLoan(2, "4189AE64-9E95-484A-8F66-49C9DDDE6258", "BBBBBBBB-BBBB-BBBB-BBBB-BBBBBBBBBBBB", 1000000, 10.65, 7658.78, 134, "12/02/2013", "APPLIED", "SERVICE", 78576.33, 5345.55, "OTHERS"),
