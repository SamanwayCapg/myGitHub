...
namespace Capgemini.Pecunia.BusinessLayer
{
    ...
    public class TransactionBL : BLbase<Transaction>, ITransactionBL, IDisposable
    {
        ...
        public async Task<bool> DebitTransactionByWithdrawalSlipBL(Guid accountID, decimal amount)
        {
        ...
        public async Task<bool> CreditTransactionByDepositSlipBL(Guid accountID, decimal amount)
        {
            bool transactionWithdrawal = false;
            try
            {
        ...
        /// <returns>Determinates whether the amount is debited by withdrawal slip.</returns>
        public async Task<bool> DebitTransactionByChequeBL(Guid accountID, decimal amount, string chequeNumber)
        {
        ...
        public async Task<bool> CreditTransactionByChequeBL(Guid accountID, decimal amount, string chequeNumber)
        {
            bool transactionCheque = false;
            try
            {
        ...
        public async Task<List<Transaction>> DisplayTransactionByAccountIDBL(string accountID)
        {
            ...
            try
            {
                ...
                {
                    TransactionDAL transactionDAL = new TransactionDAL();
                    tr = transactionDAL.DisplayTransactionByAccountIDDAL(accountID);
        ...
        {
            List<Transaction> ds = new List<Transaction>();
            try
            {
                ds = await transactionDAL.GetAllTransactionsDAL();
                return ds;
            }
            catch (PecuniaException ex)
            {
        ...
        public async Task<List<Account>> GetAllAccountsBL()
        {
            List<Account> ds = new List<Account>();
            try
            {
                ds = await transactionDAL.GetAllAccountsDAL();
                return ds;
            }
            catch (Exception)
            {
