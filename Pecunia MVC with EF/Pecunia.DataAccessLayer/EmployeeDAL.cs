...
namespace Capgemini.Pecunia.DataAccessLayer
{
    ...
    //            SqlParameter p3 = new SqlParameter("@empemail", newEmployee.Email);
    //            SqlParameter p4 = new SqlParameter("@emppassword", newEmployee.Password);
    ...
    //                employee.Email = (string)dataRow["EmployeeEmail"];
    ...
    //                    matchingEmployee.Email = sqlDataReader.GetString(2);
    ...
    //            SqlParameter p3 = new SqlParameter("@empemail", updateEmployee.Email);              
    ...
    //            SqlParameter p1 = new SqlParameter("@empid", updateEmployee.EmployeeID);
    //            p1.DbType = DbType.Guid;
    //            SqlParameter p2 = new SqlParameter("@emppassword", updateEmployee.Password);
    //            List<SqlParameter> sqlParameters = new List<SqlParameter>();
    //            sqlParameters.Add(p1);
    //            sqlParameters.Add(p2);
    //            sqlCommand.Parameters.AddRange(sqlParameters.ToArray());
